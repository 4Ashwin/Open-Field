            ...
            <div className='text-black mt-28'>
                ...
                <table className="min-w-full bg-white border border-gray-300">
                    ...
                    {pesticidesData.map((pesticide) => (
                        <tr key={pesticide.pesticide_id}>
                        <td className="py-2 px-4 border-b">{pesticide.pesticide_id}</td>
                        <td className="py-2 px-4 border-b">{pesticide.batch_no}</td>
                        <td className="py-2 px-4 border-b">{pesticide.ingredient_info}</td>
                        <td className="py-2 px-4 border-b">{pesticide.manufacturing_date}</td>
                        <td className="py-2 px-4 border-b">{pesticide.expiring_date}</td>
